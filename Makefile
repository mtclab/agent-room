...
# transcript rolling under it, X-1/X-2/X-3 what is a line of conversation and
# what corrects one; M1-M5 the MCP server and D1 the doctor. The Claude gates
# spend the owner's quota and have a target of their own.
live:
	AGENT_ROOM_LIVE=1 $(LIVE_VENV)/pytest -q tests/live/test_journeys.py \
		...
		tests/live/test_rotation.py tests/live/test_corrections.py \
